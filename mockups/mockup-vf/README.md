...
| `performance-FINAL.html` | Performance (tab) + Account Portfolio | rich (chips · summary + graph · all-accounts walk · per-account walks · category earnings) · account portfolio · day-one | 2026-08-04 (from performance-final-v7) |
