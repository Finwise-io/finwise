...
const s = StyleSheet.create({
  ...
  kicker: { fontSize: 13, fontWeight: '800', color: Colors.primary, letterSpacing: 2, marginTop: 4 },
  heroTitle: { fontSize: 24, fontWeight: '800', color: Colors.textPrimary, textAlign: 'center', marginTop: 4 },
  heroSub: { fontSize: 15, color: Colors.primaryDark, textAlign: 'center', marginTop: 6, marginHorizontal: 10 },
  ...
  modIcon: { fontSize: 24, width: 30, textAlign: 'center' },
  modTitle: { fontSize: 15, fontWeight: '700', color: Colors.textPrimary },
  modDesc: { fontSize: 13, color: Colors.textSecondary, marginTop: 2 },
  badge: { backgroundColor: Colors.primaryLight, borderRadius: Radii.sm, paddingHorizontal: 8, paddingVertical: 4 },
  badgeTxt: { fontSize: 11, fontWeight: '800', color: Colors.primaryDark, letterSpacing: 0.5 },
  arrow: { fontSize: 17, color: Colors.primary, fontWeight: '700' },
