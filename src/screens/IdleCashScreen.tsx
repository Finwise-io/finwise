...
const styles = StyleSheet.create({
  ...
  section: { fontSize: 13, fontWeight: '800', color: Colors.textTertiary, letterSpacing: 0.5, marginTop: Spacing.lg, marginBottom: 6 },
  ...
  note: { fontSize: 13, color: Colors.textSecondary, lineHeight: 18, marginTop: 10 },
