...
const styles = StyleSheet.create({
  ...
  emoji: { fontSize: 38, textAlign: 'center', marginTop: 8 },
  h1: { fontSize: 24, fontWeight: '800', color: Colors.textPrimary, marginTop: 8, textAlign: 'center' },
  sub: { fontSize: 15, color: Colors.textSecondary, lineHeight: 20, textAlign: 'center', marginTop: 6, marginBottom: Spacing.lg },
  ...
  label: { fontSize: 13, fontWeight: '700', color: Colors.textTertiary, marginBottom: 6 },
  ...
  cTicker: { flex: 1.5 },
  secName: { fontSize: 15, fontWeight: '700', color: Colors.textPrimary },
  ...
  mergeHead: { fontSize: 15, fontWeight: '800', color: Colors.textPrimary, marginBottom: 8 },
  ...
  totalVal: { fontSize: 15, fontWeight: '800', color: Colors.textPrimary, textAlign: 'right' },
  note: { fontSize: 11, color: Colors.textTertiary, lineHeight: 16, textAlign: 'center', marginTop: 12 },
  ...
  primaryTxt: { color: Colors.white, fontWeight: '800', fontSize: Typography.sizes.md },
