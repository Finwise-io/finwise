...
const s = StyleSheet.create({
  ...
  instTxt: { flex: 1, fontSize: 15.5, fontWeight: '600', color: Colors.textPrimary },
  chev: { fontSize: 18, color: Colors.textTertiary },
  divider: { borderTopWidth: 1, borderTopColor: Colors.bgTertiary },
  line: { fontSize: 14.5, color: Colors.textPrimary, lineHeight: 21, flex: 1 },
  ...
  doorTxt: { fontSize: 14.5, fontWeight: '700', color: Colors.primaryDark },
