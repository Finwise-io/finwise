...
const s = StyleSheet.create({
  ...
  hero: { fontSize: 34, fontWeight: '800', marginTop: 2, fontVariant: ['tabular-nums'] },
  ...
  input: { borderWidth: 1.5, borderColor: Colors.border, borderRadius: Radii.md, padding: 12, fontSize: 16, color: Colors.textPrimary, marginTop: 8, minHeight: 48, backgroundColor: Colors.cardBg },
  ...
  foot: { fontSize: 11.5, color: Colors.textTertiary, marginTop: 6 },
});
