...
const s = StyleSheet.create({
  ...
  section: { fontSize: 13, fontWeight: '800', color: Colors.textTertiary, letterSpacing: 0.5, marginBottom: 6 },
  ...
  dialLabel: { flex: 1, fontSize: 15, fontWeight: '700', color: Colors.textPrimary, marginLeft: 10 },
  dialAmt: { fontSize: 15, fontWeight: '700', color: Colors.textPrimary, fontVariant: ['tabular-nums'] },
  ...
  stepTxt: { fontSize: 17, fontWeight: '700', color: Colors.primary },
  endDate: { fontSize: 13, color: Colors.textSecondary, flexShrink: 1 },
  verdict: { fontSize: 20, fontWeight: '800', marginTop: 4 },
  hint: { fontSize: 13, color: Colors.textTertiary, marginTop: 4, lineHeight: 17 },
  link: { fontSize: 13, fontWeight: '700', color: Colors.primary, marginTop: 8 },
  row: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 4 },
  rowL: { fontSize: 13, color: Colors.textPrimary, flex: 1 },
  rowV: { fontSize: 13, color: Colors.textPrimary, fontVariant: ['tabular-nums'] },
  ...
  hintTxt: { fontSize: 13, color: Colors.textPrimary, lineHeight: 19 },
