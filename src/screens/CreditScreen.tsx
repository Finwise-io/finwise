...
const styles = StyleSheet.create({
  ...
  fieldL: { fontSize: 13, fontWeight: '700', color: Colors.textSecondary, marginBottom: 5 },
  ...
  utilPct: { fontSize: 30, fontWeight: '800' },
  utilStatus: { fontSize: 13, color: Colors.textSecondary, flex: 1 },
  ...
  bandTxt: { fontSize: 17, fontWeight: '800', marginTop: 8 },
  ...
  habitTitle: { fontSize: 15, fontWeight: '800', color: Colors.textPrimary },
  habitSub: { fontSize: 13, color: Colors.textSecondary, marginTop: 2, lineHeight: 17 },
