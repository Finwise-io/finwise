...
export default function GoalsScreen() {
  ...
  // B-28 + build-34 #1: "free cash to save" is the canonical SURPLUS = take-home − spending − DEBT.
  // surplusByMonth subtracts debt service, so this matches Home/Budget/Cash-Flow (not income-after-spend,
...
const styles = StyleSheet.create({
  ...
  creditTitle: { fontSize: 15, fontWeight: '800', color: Colors.textPrimary },
  creditSub: { fontSize: 11, color: Colors.textSecondary, marginTop: 1 },
  creditArrow: { fontSize: 24, color: Colors.textTertiary },
  loanBig: { fontSize: 24, fontWeight: '800', color: Colors.textPrimary },
  loanBigSub: { fontSize: 15, fontWeight: '600', color: Colors.textTertiary },
  ...
  dtiSub: { fontSize: 11, color: Colors.textSecondary, marginTop: 1 },
  capCard: { backgroundColor: Colors.primaryLight, borderRadius: Radii.lg, padding: Spacing.md, marginTop: 14 },
  capVal: { fontSize: 24, fontWeight: '800', color: Colors.primaryDark },
  capLab: { fontSize: 13, color: Colors.textSecondary, marginTop: 2, lineHeight: 16 },
  ...
  suggestTitle: { fontSize: 15, fontWeight: '800', color: Colors.textPrimary },
  suggestSub: { fontSize: 13, color: Colors.textSecondary, marginTop: 4, lineHeight: 17 },
  suggestCta: { fontSize: 13, fontWeight: '800', color: Colors.primary, marginTop: 8 },
  ...
  segT: { fontSize: 13, fontWeight: '800', color: Colors.textSecondary },
  segTOn: { color: Colors.primaryDark },
  segSub: { fontSize: 11, color: Colors.textTertiary, marginTop: 1 },
  note: { fontSize: 11, color: Colors.textSecondary, lineHeight: 16, marginTop: 8 },
  dRow: { marginTop: 12 },
  dL: { fontSize: 13, color: Colors.textSecondary, fontWeight: '600' },
  ...
  amtPre: { fontSize: 17, color: Colors.textSecondary },
  amtIn: { flex: 1, padding: 11, fontSize: 17, color: Colors.textPrimary },
  ...
  resultSub: { fontSize: 13, color: Colors.textSecondary, marginTop: 3 },
  ...
  orderName: { flex: 1, fontSize: 13, fontWeight: '700', color: Colors.textPrimary },
  orderMo: { fontSize: 11, color: Colors.textTertiary },
  ...
  sheetT: { fontSize: 17, fontWeight: '800', color: Colors.textPrimary, marginBottom: 8 },
