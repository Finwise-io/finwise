...
const styles = StyleSheet.create({
  ...
  input: { fontSize: 30, fontWeight: '800', color: Colors.textPrimary, minWidth: 110, padding: 0, marginLeft: 4 },
  perMo: { fontSize: 15, color: Colors.textSecondary },
  finder: { fontSize: 13, color: Colors.textTertiary, marginTop: 8, lineHeight: 17 },
  exampleBanner: { fontSize: 13, fontWeight: '700', color: Colors.textSecondary, backgroundColor: Colors.bgTertiary, borderRadius: Radii.md, padding: 10, marginBottom: Spacing.sm, overflow: 'hidden' },
  sandboxBanner: { fontSize: 13, fontWeight: '700', color: Colors.primaryDark, backgroundColor: Colors.primaryLight, borderRadius: Radii.md, padding: 10, marginBottom: Spacing.sm, overflow: 'hidden' },
  tableHead: { flexDirection: 'row', paddingBottom: 6 },
  th: { fontSize: 11, fontWeight: '800', color: Colors.textTertiary, letterSpacing: 0.4 },
  ...
  tableNote: { fontSize: 13, color: Colors.textTertiary, marginTop: 8 },
  ...
  remindTxt: { fontSize: 13, fontWeight: '800', color: Colors.primary },
  ...
  couplesNote: { fontSize: 13, color: Colors.textTertiary, lineHeight: 17, marginTop: 8 },
  receiveHead: { fontSize: 17, fontWeight: '800', color: Colors.textPrimary },
  body: { fontSize: 15, color: Colors.textSecondary, lineHeight: 20, marginTop: 8 },
  ...
  modalT: { fontSize: 17, fontWeight: '800', color: Colors.textPrimary },
