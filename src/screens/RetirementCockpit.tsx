  ...
  return (
    <View style={{ width: size, height: size, alignItems: 'center', justifyContent: 'center' }}
      ...
      <Svg width={size} height={size} style={{ position: 'absolute' }}>
        <G transform={`rotate(-90 ${size / 2} ${size / 2})`}>{/* plain SVG transform — rotation/origin emit an invalid DOM attribute on web */}
    ...
    <Modal visible={open} transparent animationType={modalAnimation()} onRequestClose={onClose}>
      ...
      <View style={styles.sheet}>
        ...
        <View style={styles.acc}>
          ...
          <Switch value={eligible} onValueChange={setEligible} trackColor={{ true: Colors.primaryMid, false: Colors.border }} thumbColor={eligible ? Colors.primary : Colors.white} />
        </View>
        {eligible && (
          <>
            <View style={styles.acc}>
...
const styles = StyleSheet.create({
  ...
  lgL: { flex: 1, fontSize: 13, color: Colors.textPrimary },
  lgPct: { color: Colors.textTertiary, fontSize: 11 },
  lgV: { fontSize: 13, fontWeight: '700', color: Colors.textPrimary },
  editLink: { marginTop: 12, fontSize: 13, fontWeight: '700', color: Colors.primary, textAlign: 'center' },
  ...
  heroBig: { color: Colors.white, fontSize: 24, fontWeight: '800', marginVertical: 3 },
  heroSub: { color: Colors.onDeepTint, fontSize: 11, fontWeight: '600', lineHeight: 14 },
  heroRoi: { color: Colors.primaryMid, fontSize: 11, fontWeight: '700', marginTop: 5 },
  ...
  dwV: { fontSize: 15, fontWeight: '800', color: Colors.textPrimary },
  dwTotal: { borderTopWidth: 1, borderTopColor: Colors.border, marginTop: 4, paddingTop: 8 },
  dwBig: { fontSize: 24, fontWeight: '800', color: Colors.textPrimary, marginVertical: 2 },
  ...
  rateTxt: { flex: 1, fontSize: 13, color: Colors.textSecondary, lineHeight: 16 },
  ...
  orderNum: { width: 22, height: 22, borderRadius: 11, backgroundColor: Colors.primaryLight, color: Colors.primaryDark, fontWeight: '800', fontSize: 13, textAlign: 'center', lineHeight: 22, overflow: 'hidden' },
  orderName: { fontSize: 13, fontWeight: '700', color: Colors.textPrimary },
  orderAmt: { fontSize: 13, fontWeight: '700', color: Colors.textSecondary },
  orderWhy: { fontSize: 11, color: Colors.textTertiary, marginTop: 2, lineHeight: 15 },
  orderCalc: { fontSize: 11, color: Colors.primaryDark, fontWeight: '600', marginTop: 3, lineHeight: 15 },
  cardDivider: { height: 1, backgroundColor: Colors.bgTertiary, marginVertical: 12 },
  heroExplain: { fontSize: 13, color: Colors.textSecondary, lineHeight: 16, marginTop: 8 },
  planStmt: { fontSize: 13, color: Colors.primaryDark, fontWeight: '600', marginTop: 8, lineHeight: 16 },
  ...
  basisPillT: { fontSize: 11, fontWeight: '700', color: Colors.textSecondary },
  ...
  tFootMuted: { fontSize: 11, color: Colors.textTertiary, lineHeight: 13.5, marginTop: 6 },
  srcTag: { fontSize: 11, color: Colors.textTertiary, fontWeight: '700' },
  instWarn: { fontSize: 11, color: Colors.amber, fontWeight: '700', marginTop: 1 },
  ...
  kindIc: { fontSize: 15 },
  kindT: { fontSize: 13, fontWeight: '700', color: Colors.textPrimary },
  ...
  scenarioBtn2T: { fontSize: 13, fontWeight: '700', color: Colors.textPrimary },
  ...
  gAge: { color: Colors.white, fontSize: 38, fontWeight: '800', marginVertical: 2 },
  gSub: { color: Colors.onDeepTint, fontSize: 13, fontWeight: '600' },
  ...
  verdictHead: { fontSize: 17, fontWeight: '800', color: Colors.textPrimary },
  verdictBody: { fontSize: 15, color: Colors.textPrimary, marginTop: 5, lineHeight: 20 },
  verdictSub: { fontSize: 13, color: Colors.textSecondary, marginTop: 6, lineHeight: 18 },
  ...
  detailsBtnTxt: { fontSize: 13, fontWeight: '700', color: Colors.textPrimary },
  insightTxt: { color: Colors.primaryDark, fontSize: 13, lineHeight: 18 },
  ...
  ssIc: { fontSize: 17 },
  ssName: { fontSize: 15, fontWeight: '700', color: Colors.textPrimary },
  ssSub: { fontSize: 11, color: Colors.textSecondary, marginTop: 1 },
  ...
  section: { fontSize: 13, fontWeight: '800', color: Colors.textTertiary, letterSpacing: 0.5, marginTop: Spacing.base, marginBottom: 6 },
  ...
  instIc: { fontSize: 17 },
  instName: { fontSize: 13, fontWeight: '700', color: Colors.textPrimary },
  instSrc: { fontSize: 13, color: Colors.textSecondary, marginTop: 1, lineHeight: 16 },
  instBal: { fontSize: 13, fontWeight: '700', color: Colors.textPrimary },
  instRet: { fontSize: 13, fontWeight: '800', color: Colors.primary, textAlign: 'right' },
  instBench: { fontSize: 13, fontWeight: '700', color: Colors.textSecondary, textAlign: 'right' },
  ttmAdd: { fontSize: 13, fontWeight: '700', color: Colors.primary, textAlign: 'right' },
  instLinks: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 },
  editLink2: { fontSize: 13, fontWeight: '700', color: Colors.primary },
  tFoot: { fontSize: 11, color: Colors.textTertiary, lineHeight: 14, marginTop: 8 },
  benchCaveat: { fontSize: 11, color: Colors.textTertiary, lineHeight: 14, marginTop: 6, fontStyle: 'italic' },
  clearLink: { fontSize: 13, fontWeight: '700', color: Colors.red, textAlign: 'center', marginTop: 12 },
  ...
  bdV: { fontSize: 13, fontWeight: '800', color: Colors.textPrimary },
  bdL: { fontSize: 11, color: Colors.textSecondary, marginTop: 1 },
  bdOp: { fontSize: 13, color: Colors.textTertiary, fontWeight: '700', marginBottom: 10 },
  ...
  benchBig: { fontSize: 30, fontWeight: '800', color: Colors.textPrimary, marginVertical: 1 },
  benchD: { fontSize: 13, color: Colors.textSecondary, lineHeight: 18, marginTop: 3 },
  ...
  heroColNum: { fontSize: 24, fontWeight: '800', color: Colors.textPrimary, marginTop: 3 },
  ...
  thumb: { position: 'absolute', top: -7, width: 20, height: 20, borderRadius: 10, backgroundColor: Colors.white, borderWidth: 3, marginLeft: -10 },
  ...
  confPct: { fontSize: 17, fontWeight: '800' },
  confT: { fontSize: 13, color: Colors.primaryDark, flex: 1, lineHeight: 15 },
  save: { backgroundColor: Colors.primary, borderRadius: Radii.md, paddingVertical: 14, alignItems: 'center', marginTop: 14 },
  saveT: { color: Colors.white, fontSize: 15, fontWeight: '800' },
  foot: { fontSize: 11, color: Colors.textTertiary, textAlign: 'center', marginTop: 8 },

  horizonRow: { flexDirection: 'row', alignItems: 'center', gap: 10, marginTop: 10, minHeight: 44 },
  horizonLabel: { fontSize: 15, fontWeight: '700', color: Colors.textPrimary, width: 92 },
  ...
  horizonBtnT: { fontSize: 17, fontWeight: '800', color: Colors.primaryDark },
  horizonVal: { fontSize: 17, fontWeight: '800', color: Colors.textPrimary, width: 40, textAlign: 'center', fontVariant: ['tabular-nums'] },
  horizonHint: { flex: 1, fontSize: 11, color: Colors.textTertiary },
  chipPicked: { borderColor: Colors.primary, backgroundColor: Colors.primaryLight },
  compareLink: { fontSize: 13, fontWeight: '800', color: Colors.primaryDark, paddingVertical: 6 },
  ...
  cmpCell: { flex: 1, fontSize: 15, color: Colors.textPrimary, fontVariant: ['tabular-nums'] },
  cmpLabel: { color: Colors.textSecondary, fontWeight: '700', fontSize: 13 },
  cmpColHead: { fontWeight: '800', fontSize: 13 },
  cmpDiff: { fontWeight: '800' },
  cmpNote: { fontSize: 13, color: Colors.textTertiary, marginTop: 10, lineHeight: 17 },
  ...
  chipT: { fontSize: 13, fontWeight: '700', color: Colors.textPrimary },
  chipHint: { fontSize: 13, color: Colors.textTertiary, width: '100%' },
  ...
  chip2T: { color: Colors.white, fontSize: 11, fontWeight: '700' },
  ...
  liK: { fontSize: 13, color: Colors.textSecondary, flexShrink: 1, paddingRight: 8 },
  ...
  sheetS: { fontSize: 13, color: Colors.textSecondary, marginTop: 3, marginBottom: 8, lineHeight: 17 },
  ...
  accBal: { fontSize: 11, color: Colors.textTertiary, marginTop: 1 },
  pctBox: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  pctIn: { width: 56, borderWidth: 1.5, borderColor: Colors.border, borderRadius: 8, padding: 6, textAlign: 'right', fontSize: 15, fontWeight: '700', color: Colors.textPrimary },
  autoLink: { color: Colors.primary, fontSize: 13, fontWeight: '600', marginLeft: 6 },
  pctU: { fontSize: 13, color: Colors.textSecondary },
  counts: { fontSize: 13, fontWeight: '700', color: Colors.primary, minWidth: 60, textAlign: 'right' },
  ...
  stepBtnT: { fontSize: 17, color: Colors.primary, fontWeight: '700' },
  stepVal: { fontSize: 17, fontWeight: '800', color: Colors.textPrimary, minWidth: 30, textAlign: 'center' },
  applyBtn: { backgroundColor: Colors.primary, borderRadius: Radii.md, paddingVertical: 14, alignItems: 'center', marginTop: 16 },
  applyT: { color: Colors.white, fontSize: 15, fontWeight: '800' },
  dialog: { position: 'absolute', left: 24, right: 24, top: '32%', backgroundColor: Colors.white, borderRadius: Radii.lg, padding: 18 },
