...
const styles = StyleSheet.create({
  ...
  rowL: { flex: 1, fontSize: 14.5, color: Colors.textPrimary },
  rowV: { fontSize: 14.5, color: Colors.textPrimary, fontVariant: ['tabular-nums'] },
  strong: { fontWeight: '800' },
  dividerLine: { height: 1, backgroundColor: Colors.border, marginVertical: 6 },
  empty: { fontSize: 13.5, color: Colors.textSecondary, paddingVertical: 4 },
