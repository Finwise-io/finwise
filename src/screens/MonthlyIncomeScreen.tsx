...
const styles = StyleSheet.create({
  ...
  section: { fontSize: 16, fontWeight: '700', color: Colors.textPrimary, marginBottom: Spacing.xs },
  label: { fontSize: 13, color: Colors.textSecondary, marginTop: Spacing.xs, marginBottom: 4 },
  input: { borderWidth: 1, borderColor: Colors.border, borderRadius: Radii.md, padding: 12, fontSize: 18, color: Colors.textPrimary, backgroundColor: Colors.bgSecondary },
  inputSm: { borderWidth: 1, borderColor: Colors.border, borderRadius: Radii.md, padding: 10, fontSize: 16, color: Colors.textPrimary, backgroundColor: Colors.bgSecondary, width: 90 },
  row: { flexDirection: 'row', gap: 8, marginBottom: Spacing.xs },
  chips: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: Spacing.xs },
  chip: { paddingVertical: 10, paddingHorizontal: 14, borderRadius: 999, borderWidth: 1, borderColor: Colors.border, backgroundColor: Colors.bgSecondary },
  chipOn: { backgroundColor: Colors.primaryLight, borderColor: Colors.primary },
  chipT: { fontSize: 14, color: Colors.textSecondary },
  chipTOn: { color: Colors.primaryDark, fontWeight: '600' },
  mChip: { paddingVertical: 6, paddingHorizontal: 10, borderRadius: 999, borderWidth: 1, borderColor: Colors.border, backgroundColor: Colors.bgSecondary },
  mChipT: { fontSize: 12, color: Colors.textSecondary },
  link: { color: Colors.primary, fontSize: 14, fontWeight: '600', marginTop: Spacing.xs },
  ...
  totalV: { fontSize: 28, fontWeight: '700', color: Colors.primaryDark },
  ...
  saveT: { color: '#fff', fontSize: 17, fontWeight: '700' },
});
