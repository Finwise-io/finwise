...
const s = StyleSheet.create({
  ...
  schedYear: { fontSize: 14.5, color: Colors.textSecondary },
  schedAmt: { fontSize: 14.5, color: Colors.textPrimary, fontVariant: ['tabular-nums'] },
  ...
  acctBal: { fontSize: 14.5, color: Colors.textSecondary, fontVariant: ['tabular-nums'] },
