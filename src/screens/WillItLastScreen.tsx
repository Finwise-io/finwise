...
const s = StyleSheet.create({
  ...
  headline: { fontSize: 24, fontWeight: '800', color: Colors.textPrimary },
  est: { fontSize: 15, fontWeight: '500', color: Colors.textTertiary },
  bandTxt: { fontSize: 13, color: Colors.textSecondary, marginTop: 4 },
  body: { fontSize: 15, color: Colors.textSecondary, lineHeight: 21, marginTop: 4 },
  section: { fontSize: 13, fontWeight: '800', color: Colors.textTertiary, letterSpacing: 0.5, marginTop: Spacing.xs, marginBottom: 6 },
  driverRow: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingVertical: 10, minHeight: 48 },
  divider: { borderTopWidth: 1, borderTopColor: Colors.border },
  driverL: { fontSize: 15, fontWeight: '700', color: Colors.textPrimary },
  driverSrc: { fontSize: 13, color: Colors.textTertiary, marginTop: 1 },
  ...
  arrow: { fontSize: 17, color: Colors.textTertiary },
