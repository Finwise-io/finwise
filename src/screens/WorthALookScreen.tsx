...
const styles = StyleSheet.create({
  ...
  magnifier: { fontSize: 38, textAlign: 'center', marginVertical: Spacing.md },
  ...
  whyHead: { fontSize: 13, fontWeight: '800', color: Colors.textTertiary, letterSpacing: 0.5, marginTop: Spacing.lg, marginBottom: 6 },
  whyBody: { fontSize: 15, color: Colors.textPrimary, lineHeight: 22 },
  softener: { fontSize: 15, color: Colors.textSecondary, lineHeight: 20, marginTop: 8 },
  ...
  checklistItem: { fontSize: 15, color: Colors.textPrimary, lineHeight: 21, marginBottom: 8 },
