...
const s = StyleSheet.create({
  ...
  tabCellTxt: { fontSize: 11, fontWeight: '800', color: Colors.primaryDark, marginTop: 4 },
  ...
  giE: { fontSize: 24 },
  giT: { fontSize: 11, fontWeight: '700', color: Colors.textPrimary, marginTop: 4, textAlign: 'center', lineHeight: 13 },
  ...
  footerE: { fontSize: 15 },
  footerT: { fontSize: 13, fontWeight: '700', color: Colors.textSecondary },
});
