...
const s = StyleSheet.create({
  ...
  body: { fontSize: Typography.sizes.base, color: Colors.textSecondary, lineHeight: 22, textAlign: 'center', marginBottom: Spacing.base },
  ...
  shareBtn: { paddingVertical: Spacing.md, marginBottom: Spacing.sm, minHeight: 44, justifyContent: 'center' },
  shareTxt: { color: Colors.primary, fontWeight: '700', fontSize: Typography.sizes.md },
  ackRow: { flexDirection: 'row', alignItems: 'center', alignSelf: 'stretch', gap: 10, marginBottom: Spacing.base, paddingVertical: 10, minHeight: 44 },
