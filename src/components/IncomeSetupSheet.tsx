...
const s = StyleSheet.create({
  ...
  qsub: { fontSize: 11, color: Colors.textTertiary, marginTop: 1, fontWeight: '400' },
  ...
  frameT: { fontSize: 13, fontWeight: '700', color: Colors.textSecondary },
  ...
  moM: { fontSize: 11, fontWeight: '800', color: Colors.textTertiary },
  moV: { fontSize: 13, fontWeight: '700', color: Colors.textPrimary, fontVariant: ['tabular-nums'] },
  ...
  saveT: { fontSize: 17, fontWeight: '800', color: Colors.white },
  saved: { fontSize: 11, fontWeight: '600', color: Colors.primaryDark, marginTop: 10 },
});
