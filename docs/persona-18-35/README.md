...
All documents for the 18–35 focus area live in this folder. This is the first persona of the two-persona
platform plan (see the "Phase 2 — Persona platform" tab in `../finwise-master-action-list-*.xlsx`).
