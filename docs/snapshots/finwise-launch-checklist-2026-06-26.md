...
> **Canonical launch doc** (see `docs/README.md` for the full index). **Last verified: 2026-06-26.**
> All code workstreams (accuracy, compliance themes 1–5, goals→surplus, device fixes) are done on
> branch `taxonomy-v1.0.7`; B-L2 (Sentry) is fully wired. **2026-06-26: all 17 build-33 device-test
> findings fixed (B-73..B-89, incl. the T22 route-guard loop), 739 tests green.** Remaining = manual
> launch tasks + cut the build (see Phase 1.3 for the build-#35 quota blocker).
