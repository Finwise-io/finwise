...
export default function RootLayout() {
  ...
  useEffect(() => {
    ...
    const inModals     = ['income','expense','savings','invest','jobsafety','income-detail','income-manager','performance','bonds','other-investments','sharpen','insights','bill-calendar','credit','stress-test','education','retirement'].includes(segments[0] as string);
    if (user) {
