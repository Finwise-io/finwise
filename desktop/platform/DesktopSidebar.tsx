...
const s = StyleSheet.create({
  ...
  brandT: { color: Colors.white, fontSize: 16, fontWeight: '800' },
  ...
  itemT: { color: Colors.primaryMid, fontSize: 14, fontWeight: '600' },
  ...
  footT: { color: Colors.primaryMid, fontSize: 12.5, fontWeight: '600' },
});
